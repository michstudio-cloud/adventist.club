...
**En curso (agente, frontend):** `feat/desktop-fase3` (panel del director 04 + asistente a dos columnas 05). Al terminar: fusionar, gates, 375/768 idénticos, publicar; luego fase 5 (regresión, AA, teclado).
